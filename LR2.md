...
> 
Данная команда создала резервную копию **только одной таблицы** `slaves2`  
в файле `selected_tables_backup.dump` в формате **custom**.
> 
**После создания резервной копии были выполнены следующие шаги:**
> 3.1. Подключение к базе данных `postgres` через `psql`;  
> 3.2. Удаление таблицы `slaves2` с целью последующего восстановления;  
...
> После удаления таблицы `slaves` была выполнена операция её восстановления с помощью утилиты **pg_restore**:
>
> ```bash
> pg_restore -U postgres -d postgres -v selected_tables_backup.dump
> ```
>
> ![image](https://github.com/user-attachments/assets/b09d14ba-bdff-4bf3-9a56-d6338acc5c26)
...
> ```
>
> ![image](https://github.com/user-attachments/assets/e772e80c-4399-4b23-91ac-a74ca127871d)
...
>
>   ```bash
>   */15 * * * * find /home/jojo/backups/ -name "*.dump" -type f -mmin +15 -exec rm {} \;
>   ```
>
> ![image](https://github.com/user-attachments/assets/acd74064-f83d-4b57-b44b-95097f41a1ca)

> ![image](https://github.com/user-attachments/assets/8a4f4124-0739-4b72-a69f-1ba3225bf85e)

>
> Проверяем содержимое папки `/home/jojo/backups/`, чтобы убедиться, что файлы создаются каждые 2 минуты. Через некоторое время видим, что старые резервные копии удаляются, а новые продолжают появляться.  
> Ротация работает.
>
> ![image](https://github.com/user-attachments/assets/d95642c2-bc8c-4b2c-81b2-32a9ad78f609)
...
>
>![image](https://github.com/user-attachments/assets/00d06685-f615-45e3-a340-c97213a25b32)
...
>
>
>![image](https://github.com/user-attachments/assets/1961bd02-6076-4bf9-a96d-e3bb0465bcad)
...
> ```
> 
>![image](https://github.com/user-attachments/assets/a3beb40c-fdfc-492f-be39-180c9e4fa044)
...
> ```
>
>![image](https://github.com/user-attachments/assets/686926df-e5b0-4836-b10e-e6ad43e65928)
...
>```
>
>![image](https://github.com/user-attachments/assets/91d2afc1-669b-4c99-8e27-459c1a3e4745)
...
>![image](https://github.com/user-attachments/assets/d728e5fd-d67c-4f4b-97a9-77b93ef8b5b3)


**Логи всей виртуальной машины:**
>![image](https://github.com/user-attachments/assets/e6df25f3-201a-4fdd-adf8-2bf2b2418c43)
